...
public class TeleportCommands {
    ...
    @Command(names = {"tpall"}, permission = "holiday.tpall")
    ...
    @Command(names = {"tp", "teleport"}, permission = "holiday.teleport")
    ...
    @Command(names = {"tph", "tphere", "s"}, permission = "holiday.teleporthere")
    ...
    @Command(names = {"tppos", "teleportpos"}, permission = "holiday.tppos")

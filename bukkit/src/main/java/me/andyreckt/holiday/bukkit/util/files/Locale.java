...
public enum Locale {
    ...
    /* CHAT */
    GLOBAL_CHAT_CLEAR(MESSAGES.get(), "chat.chat-clear", "&cThe me.andyreckt.holiday.global chat has been cleared."),
    STAFF_CHAT_CLEAR(MESSAGES.get(), "chat.staff.chat-clear", "&b[S] &3[%server%] &eThe chat has been cleared by %executor%"),
    GLOBAL_CHAT_MUTED(MESSAGES.get(), "chat.chat-muted", "&cThe me.andyreckt.holiday.global chat has been muted."),
    STAFF_CHAT_MUTED(MESSAGES.get(), "chat.staff.chat-muted", "&b[S] &3[%server%] &eThe chat has been muted by %executor%"),
    GLOBAL_CHAT_UNMUTED(MESSAGES.get(), "chat.chat-unmuted", "&aThe me.andyreckt.holiday.global chat has been unmuted."),
    STAFF_CHAT_UNMUTED(MESSAGES.get(), "chat.staff.chat-unmuted", "&b[S] &3[%server%] &eThe chat has been unmuted by %executor%"),
    GLOBAL_CHAT_SLOWED(MESSAGES.get(), "chat.chat-slowed", "&cThe me.andyreckt.holiday.global chat has been slowed to %delay% seconds."),
    ...
    GLOBAL_CHAT_UNSLOWED(MESSAGES.get(), "chat.chat-unslowed", "&aThe me.andyreckt.holiday.global chat has been unslowed."),
    ...
    /* WHITELIST */
    GLOBAL_WHITELIST_ENABLED(MESSAGES.get(), "whitelist.whitelist-enabled", "&cThe whitelist has been enabled."),
    ...
    GLOBAL_WHITELIST_DISABLED(MESSAGES.get(), "whitelist.whitelist-disabled", "&aThe whitelist has been disabled."),
    ...
    CHAT_CURRENTLY_MUTED(MESSAGES.get(), "error.chat-currently-muted", "&cThe me.andyreckt.holiday.global chat is currently muted."),

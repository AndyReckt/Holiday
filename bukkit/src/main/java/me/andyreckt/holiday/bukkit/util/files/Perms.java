...
public enum Perms {
    ...
    USER("command.me.andyreckt.holiday.user", "core.command.me.andyreckt.holiday.user"),
    USER_WIPE("command.me.andyreckt.holiday.user-wipe", "core.command.me.andyreckt.holiday.user.wipe"),

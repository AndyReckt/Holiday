...
public class TeleportCommands {
    ...
    @Command(names = {"tpall"}, permission = Perms.TELEPORT_ALL, description = "Teleport all players to you.", usage = "/tpall")
    ...
    @Command(names = {"tp", "teleport"}, permission = Perms.TELEPORT, description = "Teleport to a player.", usage = "/tp <player>")
    ...
    @Command(names = {"tph", "tphere", "s"}, permission = Perms.TELEPORT_HERE, description = "Teleport a player to you.", usage = "/tph <player>")
    ...
    @Command(names = {"tppos", "teleportpos"}, permission = Perms.TELEPORT_POSITION, description = "Teleport to a position.", usage = "/tppos <x> <y> <z>")
